...
const WhatsAppButton = ({ phoneNumber, message = "Hello! I'm interested in your services.", className = '' }: WhatsAppButtonProps) => {
  ...
  return (
    <button
      onClick={handleClick}
      className={`fixed bottom-20 sm:bottom-6 right-4 sm:right-6 bg-green-600 hover:bg-green-700 text-white rounded-full shadow-lg z-50 flex items-center justify-center transition-all duration-300 ${
