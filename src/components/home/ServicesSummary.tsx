    ...
    <section className="py-20 bg-white">
      <div className="container-custom">
        <div className="text-center mb-16">
          <h2 className="heading-lg text-wings-navy mb-4">Our Services</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Wings Ltd. offers comprehensive engineering solutions for power generation needs across East Africa.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-wings-navy mb-3">{service.title}</h3>
